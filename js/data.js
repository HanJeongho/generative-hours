...
export const WORKS = [
  ...
  {
    no: "75", wing: "light", title: "Stray Light", ko: "길 잃은 빛",
...
no: "45", wing: "time", title: "Sand Mandala", ko: "모래 만다라",
  ...
  {
    no: "69", wing: "time", title: "The Worn Step", ko: "닳는 자리",
  ...
  {
    no: "70", wing: "time", title: "Well-Loved", ko: "닳도록 꺼내 본 기억",
  ...
  {
    no: "71", wing: "time", title: "Downstream", ko: "물살은 되돌아오지 않는다",
  ...
  {
    no: "72", wing: "time", title: "Alight", ko: "손을 펴야, 지금이 내려앉는다",
  ...
  },
{
  ...
  {
    no: "74", wing: "time", title: "One More Time", ko: "한 번 더 — 마지막인 줄 몰랐던",
    medium: "Canvas2D · 오늘 날짜로 시드된 유한한 비눗방울",
    year: "2026",
    note: "해질 무렵 짙은 남색 공기 속으로, 손짓을 따라 비눗방울이 무리 지어 천천히 피어오른다. 표면엔 청록·자홍·금이 도는 얇은 기름막 무지개가 흐르고, 방울은 정점에서 소리 없이 톡 터져 미세한 물방울로 흩어진다. 몇 번이고 불 수 있어 무한해 보이지만, 오늘 허락된 방울은 오늘 날짜로 시드된 유한한 수뿐이다. 마지막 방울은 어떤 예고도 특별한 빛도 없이, 여느 것과 똑같이 평범하게 터진다. 그 뒤론 빈 공기뿐 — 아이를 번쩍 안아 올린 마지막 날처럼, 우리는 그날을 알아채지 못한다. '한 번 더'가 마지막이 되는 순간은, 늘 그렇게 조용히 지나간다.",
    hint: "클릭·드래그 = 입김으로 방울 불기 · 방울은 정점에서 톡 터진다 · 오늘의 방울은 유한하다 (남은 수는 보이지 않는다) · 자정에 새 하루",
    module: "./pieces/74-onemoretime.js",
  },
  {
