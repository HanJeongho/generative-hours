  ...
  },
{
  ...
  { no: "85", wing: "hanguk", title: "Star Chart 1395", ko: "천상열차분야지도 — 두 개의 하늘", medium: "Canvas2D · 절차적 각석 · 항성시 계산", year: "2026", note: "1395년 조선은 온 하늘의 별을 검은 돌에 새겼다. 이 각석을 이미지 없이 처음부터 그려 되살린다. 밝은 별은 실제 적경과 적위로 놓이고, 새김눈은 음각의 어두운 홈과 빛을 받는 안쪽 벽으로 돋을새김된다. 별자리 가까이 손을 대면 그 새김이 달빛으로 은은히 깨어나고, 화면 오른쪽에 그 별자리의 이야기 — 동양 천문에서의 이름과 뜻 — 가 한지 명패로 함께 떠오른다. 손이 떠나면 빛도 이야기도 서서히 돌 속으로 가라앉는다.", hint: "별자리 근처에 손 대기 = 새김이 달빛으로 깨어나고 오른쪽에 그 별자리의 이야기가 떠오름 · 손을 옮기면 다른 별자리로", module: "./pieces/85-cheonsang.js" },
  {
