  ...
  },
{
  ...
  { no: "83", wing: "hanguk", title: "After Kim Hong-do — Ssireum", ko: "씨름", medium: "Living-patch warp · after Kim Hong-do (18C, public domain)", year: "2026", note: "김홍도의 〈씨름〉에서 진짜 주인공은 씨름꾼이 아니라 '판' 그 자체다. 원작 그림은 있는 그대로 두되, 인물들이 앉은 자리마다 그림을 아주 조금씩 숨쉬게 해 정지된 화폭에 생기를 불어넣었다. 한가운데 맞붙은 씨름꾼을 건드리면 들배지기 기술이 터지고, 그 찰나 판을 에워싼 구경꾼 전부가 일제히 중앙으로 쏠린다 — 갓과 부채가 들썩이고 함성의 파문이 번진다. 오직 등을 돌린 좌하단 엿장수만이 아무 일 없다는 듯 미동도 없다. 시선이 곧 힘이 되는 순간과, 그 소란에서 홀로 비켜난 조선 회화의 유머를 함께 담았다.", hint: "가운데 씨름꾼을 클릭 = 기술! 판 전체가 중앙으로 쏠립니다 · 구경꾼에 커서를 올리면 그 사람만 갸웃 · 엿장수는 끝까지 무심합니다", module: "./pieces/83-ssireum.js" },
  { no: "84", wing: "hanguk", title: "Moon Jar", ko: "달항아리", medium: "three.js / WebGL 3D · LatheGeometry", year: "2026", note: "어두운 방, 돌아가는 물레 위에 흙 한 덩이가 놓여 있다. 드래그로 옆선을 다스리면 — 세로 위치가 손이 닿는 높이, 가로로 밀면 그 띠의 반경이 늘고 준다 — 좌우 대칭의 회전체가 조금씩 부풀어 오른다. 손을 3초 떼면 방이 가마 불빛으로 차오르고 흙이 벌겋게 달아오른다. 이윽고 식으면서 흙은 유백의 백자로 변하고, 방은 달빛으로 잦아들며 항아리가 천천히 자전한다. 완벽한 원을 노리지 않은 손, 그 서툰 둥긂이 남긴 이지러짐이 곧 달항아리의 미학이다. 클릭하면 다시 흙으로 돌아가 새로 빚는다.", hint: "드래그로 옆선 빚기 · 세로=높이 가로=반경 · 손 떼고 3초=가마 · 식으면 백자 · 클릭=다시 흙 · WHEEL", module: "./pieces/84-daljar.js" },
  ...
  {
    no: "86", wing: "hanguk", title: "Tiger & Magpie", ko: "호작도",
  ...
  { no: "88", wing: "hanguk", title: "Celadon", ko: "청자 상감 — 파내고 메우는 시간", medium: "Canvas2D · 절차적 도자", year: "2026", note: "고려의 장인은 그릇을 곧바로 칠하지 않았다. 반쯤 마른 태토를 칼끝으로 파내고, 그 파인 자리를 다른 색 흙으로 메운 뒤 깎아 고르고서야 유약을 입혀 구웠다. 상감(象嵌) — 표면에 그리는 것이 아니라 살을 파내 새겨 넣는, 느리고 되돌릴 수 없는 그림이다. 여기 어두운 전시대 위 회갈색 매병을 손으로 파고, 백토로 메우고, 가마에 넣어 비색(翡色) 유리질로 피워 보라. 문양이 흙 속에서 희게 떠오르고, 유약이 식으며 천천히 빙렬(氷裂)이 번진다. 한 번의 붓질로는 얻을 수 없는, 파낸 시간만큼만 남는 그림.", hint: "드래그 = 상감 파기(음각 홈) · [학]·[구름] = 커서 자리에 문양 스탬프 · [백토 메움] = 홈을 흰 슬립으로 · [유약·번조] = 비색 유리질로 번조(문양이 희게 떠오르고 빙렬이 자람) · 빈 곳 클릭 = 회전 · [새 도자기] = 리셋", module: "./pieces/88-cheongja.js" },
  {
